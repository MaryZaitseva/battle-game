...
class Thrower extends Character {
    constructor(position) {
        ...
        this.image = "src/images/thrower.png";
        this.damage = 25;
        this.distance = 2;
        this.cost = 20;
    }
...
class Squad {
    ...
    findMember(position) {
        for (let i = 0; i < this._resources.length; i++) {
            return this._resources[i].position = position;
        }
    }
    ;
    get resources() {
...
let positions = [11, 12, 13, 14, 15, 16, 17, 18, 21, 22, 23, 24, 25, 26, 27, 28, 31, 32, 33, 34, 35, 36, 37, 38, 41, 42, 43, 44, 45, 46, 47, 48, 51, 52, 53, 54, 55, 56, 57, 58];
jquery_1.default("form").submit(function (event) {
    ...
    jquery_1.default("#player-score").html(currentPlayer.name + "'s squad");
    jquery_1.default("#points").html(`You have ${currentPlayer.points} points`);
});
jquery_1.default("#characters td").click(function (e) {
    ...
    jquery_1.default("#field td").click(function () {
        if (!clicked1)
            return;
        if (jquery_1.default(this).html()) {
            jquery_1.default(this).html("");
        }
        clicked1 = false;
        that.removeClass("clicked");
        let chosenChar = that.attr("id");
        let position = jquery_1.default(this).attr("id");
        if (chosenChar === "warrior") {
            let cost = (new Warrior("")).cost;
            if (currentPlayer.points < cost)
                return;
            playersSquad.addMember(new Warrior(position));
            jquery_1.default(this).addClass("warrior");
            currentPlayer.points -= cost;
            that.clone().css("border", "0").appendTo(jquery_1.default(this));
            jquery_1.default("#points").html(`You have ${currentPlayer.points} points`);
        }
            ...
            that.clone().css("border", "0").appendTo(jquery_1.default(this));
            jquery_1.default(this).addClass("archer");
            currentPlayer.points -= cost;
            jquery_1.default("#points").html(`You have ${currentPlayer.points} points`);
        }
            ...
            that.clone().css("border", "0").appendTo(jquery_1.default(this));
            jquery_1.default(this).addClass("thrower");
            currentPlayer.points -= cost;
            jquery_1.default("#points").html(`You have ${currentPlayer.points} points`);
        }
    });
    ...
    jquery_1.default("#info").css("visibility", "visible");
    let char;
    if (jquery_1.default(this).attr("id") === "warrior") {
        char = new Warrior("");
    }
    else if (jquery_1.default(this).attr("id") === "archer") {
        char = new Archer("");
    }
    else if (jquery_1.default(this).attr("id") === "thrower") {
        char = new Thrower("");
    }
    jquery_1.default("#info").html("Type: " + CharacterTypes[char.type] + "</br> Distance: " + char.distance + "</br>Cost: " + char.cost);
}, function () {
    jquery_1.default(this).removeClass("hover");
    jquery_1.default("#info").html("");
    jquery_1.default("#info").css("visibility", "hidden");
});
jquery_1.default("body").click(function (e) {
    var container = jquery_1.default("#characters td");
    if (!container.is(e.target) && !jquery_1.default("#field td").is(e.target)) {
        container.removeClass("clicked");
    }
});
jquery_1.default("#field td").click(function () {
    let that = jquery_1.default(this);
    jquery_1.default("#field td").each(function () {
        jquery_1.default(this).removeClass("clicked");
    });
    let position = (jquery_1.default(this).attr("id"));
    if (jquery_1.default(this).hasClass("warrior")) {
        highlight(1, position);
    }
    if (jquery_1.default(this).hasClass("archer") || jquery_1.default(this).hasClass("thrower")) {
        highlight(2, position);
    }
    if (jquery_1.default(this).hasClass("clicked")) {
        jquery_1.default(this).append(that);
    }
});
function highlight(distance, position) {
    jquery_1.default("#field td").each(function () {
        let id = jquery_1.default(this).attr("id");
        if (id === position ||
...
jquery_1.default("#enemy-squad").click(function () {
...
function placeEnemy() {
    ...
    if (!jquery_1.default("#" + position).html()) {
        jquery_1.default("#" + position).append(" Enemy<img src=" + newChar.image + ">").addClass("enemy");
    }
}
function getRandomPosition() {
    let position = positions[Math.round(Math.random() * positions.length)];
